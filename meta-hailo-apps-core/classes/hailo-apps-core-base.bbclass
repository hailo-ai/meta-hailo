# hailo-apps-core base class - setting the base configuration for meson (target, type, includes etc...)
...
HAILO_APPS_CORE_BUILD_TARGET = "all"
HAILO_APPS_CORE_BUILD_TYPE = "release"
PARALLEL_MAKE = "-j 4"
...
EXTRA_OEMESON += " \
        ...
        -Dtarget='${HAILO_APPS_CORE_BUILD_TARGET}' \
        -Dtarget_platform='${TARGET_PLATFORM}' \
        -Dcpp_std='c++17' \
        --buildtype='${HAILO_APPS_CORE_BUILD_TYPE}' \
        "
